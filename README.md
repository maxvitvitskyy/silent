...
`images/uc/` — 22 фото для карток «Silent-досвіди», по одному на сценарій.
...
Кожен файл: 760×428, JPEG q76, у середньому ~63 КБ. Вантажаться лениво
(`loading="lazy"`), тож на початкове завантаження сторінки не впливають.

Щоб замінити фото сценарію — поклади свій файл під тим самим ім'ям у `images/uc/`.
