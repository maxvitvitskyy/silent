...
'Події в ЖК': 'Events in residential complexes',
'Свято у дворі чи на паркінгу житлового комплексу — без нічних скарг від сусідніх під’їздів і без узгодження з ОСББ.': 'A celebration in the courtyard or parking level of a residential block, with no night-time complaints from neighbouring entrances and nothing to clear with the building association.',
...
'Табори та зміни': 'Church and youth camps',
