...
# частину довшого.
T = {
'Наради й планерки': 'Meetings and stand-ups',
'Кілька команд обговорюють своє в одному опенспейсі й не заважають одна одній. Ведучий чути однаково добре в кожній групі.': 'Several teams discuss their own topics in one open space without getting in each other’s way. The lead is heard equally well in every group.',
'Секційні обговорення': 'Breakout sessions',
'Три секції конференції йдуть паралельно в одній залі. Учасник перемикає канал замість того, щоб шукати інше приміщення.': 'Three conference tracks run in parallel in one hall. A participant switches channel instead of hunting for another room.',
...
'Парки й набережні': 'Parks and embankments',
'Захід просто неба в міському просторі, де гучна музика заборонена або просто недоречна поряд із людьми, що відпочивають.': 'An open-air event in a public space where loud music is either banned or simply out of place next to people who came to rest.',
...
'Літні майданчики': 'Summer terraces',
'Тераса, фудкорт чи літній майданчик: музична зона поруч зі столиками, і розмова за сусіднім столом не тоне в біті.': 'A terrace, a food court or a summer venue: a music zone right beside the tables, where the conversation at the next table is not drowned by the beat.',
'Пересувна дискотека': 'Roaming silent disco',
'Музика їде з компанією: двір, дах, парк, потім знову двір. Обладнання не привʼязане до розетки на одному місці.': 'The music travels with the group: a yard, a roof, a park, then back to the yard. The kit is not tied to one socket in one place.',
'Концерти просто неба': 'Open-air concerts',
'Сцена працює й після комендантської години майданчика: звук іде в навушники, тож обмеження за шумом на програму не впливають.': 'The stage keeps working past the venue’s curfew: the sound goes into headphones, so noise limits do not shape the programme.',
'Табори та молодіжні збори': 'Camps and youth gatherings',
'Медитація': 'Meditation',
'Фітнес-тренування': 'Fitness classes',
...
'Запис подкасту наживо': 'Live podcast recording',
'Гості в залі чують розмову так само чисто, як слухач у записі. Мікрофони не воюють із гулом приміщення.': 'The audience in the room hears the conversation as cleanly as the listener will on the recording. The microphones are not fighting the noise of the venue.',
...
'Фітнес-тренування': 'Fitness classes',
'Команди тренера чути без крику, навіть коли група велика або заняття просто неба.': 'The coach is heard without shouting, even with a large group or a class held outdoors.',
'Медитація': 'Meditation',
...
EXPERIENCE_CATEGORIES = [
    ('business',  'Бізнес',            ['Корпоративи', 'Конференції', 'Презентація релізу',
                                        ...
                                        'Сайлент-квести',
                                        'Гра «Імпостер»',
                                        'Запис подкасту наживо',
                                        'Наради й планерки',
                                        'Секційні обговорення']),
...
def build_experience_strips():
    ...
    for rel in EXPERIENCE_PAGES:
        ...
        if grid:
            ...
            # заради чого сюди приходять найчастіше. У стрічці порядок інший:
            # там картки переставляються під час прокрутки.
            rank = {n: i for i, n in enumerate(EXPERIENCE_ORDER)}
            missing = [n for n in rank if not any('data-uc="%s"' % n in c for c in cards)]
            if missing:
