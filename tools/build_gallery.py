...
for n in ORDER:
    ...
    if n in VID:
        ...
        # data-poster потрібен каруселі в лайтбоксі: сусідні ролики там показані
        # постерами, а брати їх з <img> плитки не можна — makeImageWindow
        # підміняє src далеких кадрів прозорим пікселем.
        play = ('          <button class="gal-play" type="button"'
                f' data-video="video/web/{VID[n][0]}.mp4"'
                f' data-poster="images/gal/{n:02d}_tall.webp"'
